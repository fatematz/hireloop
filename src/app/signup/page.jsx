    ...
    return (
        <div className="light w-full min-h-[85vh] flex items-center justify-center bg-[#fafafa] py-12">
            <div className="w-full max-w-[420px] bg-white p-8 rounded-xl border border-gray-200/80 shadow-[0_4px_20px_rgba(0,0,0,0.03)] mx-4">
                ...
                <div className="mb-8">
                    <h2 className="text-3xl font-bold text-black tracking-tight mb-2">Create Account</h2>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4.5">
                    ...
                    <div className="flex flex-col gap-1.5">
                        <div className="flex justify-between items-center">
                            ...
                            <span className="text-[10px] text-gray-400 font-medium bg-gray-100 px-1.5 py-0.5 rounded">Optional</span>
                        </div>
                        <input
                            type="url"
                            name='image'
