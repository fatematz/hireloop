...
//       const handleLogout = async () => {  // ← add করো
...
//                 className="bg-white text-black font-semibold text-sm px-4 py-2 rounded-xl hover:bg-gray-100 transition-all duration-200 shadow-md"
//             >
//                 Logout
//             </button>
//         </>
...
// বাটন ডুপ্লিকেশন এড়ানোর জন্য এই সাব-কম্পোনেন্ট
const AuthActions = ({ session, handleLogout, setIsOpen }) => {
    if (session) {
        return (
            <button
                onClick={handleLogout}
    ...
    return (
        <>
            <Link 
                ...
                className="text-sm font-medium text-[#6366f1] hover:text-[#4f46e5] transition-colors duration-200 px-3 py-1.5"
            >
                Sign In
            </Link>
            <Link 
